...
#    Feb 19, 2019 11:22:05 AM CET  platform: Linux
...
class PHASE_TRACKING_GUI:
    def __init__(self, top=None):
        ...
        self.Label25.place(relx=0.111, rely=0.609, height=19, width=286)
        self.Label25.configure(activebackground="#f9f9f9")
        self.Label25.configure(background="#ffffff")
        self.Label25.configure(text='''Label''')
        self.Label25.configure(textvariable=GUI_phase_support.Text1)
        ...
        self.Frame12.place(relx=0.007, rely=0.264, relheight=0.638
                , relwidth=0.482)
        self.Frame12.configure(relief=GROOVE)
        self.Frame12.configure(borderwidth="2")
        self.Frame12.configure(relief=GROOVE)
        self.Frame12.configure(width=650)

        self.Frame13 = Frame(self.TNotebook1_t3)
        self.Frame13.place(relx=0.504, rely=0.0, relheight=0.535, relwidth=0.437)
        ...
        self.Frame14.place(relx=0.541, rely=0.543, relheight=0.433
                , relwidth=0.371)
