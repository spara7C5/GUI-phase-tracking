...
#    Oct 08, 2018 03:31:19 PM CEST  platform: Linux
...
class PHASE_TRACKING_GUI:
    def __init__(self, top=None):
        ...
        self.Frame12.place(relx=0.01, rely=0.296, relheight=0.525
                , relwidth=0.475)
        self.Frame12.configure(relief=GROOVE)
        self.Frame12.configure(borderwidth="2")
        self.Frame12.configure(relief=GROOVE)
        self.Frame12.configure(width=435)

        self.Frame13 = Frame(self.TNotebook1_t3)
        self.Frame13.place(relx=0.509, rely=0.296, relheight=0.525
                , relwidth=0.475)
        self.Frame13.configure(relief=GROOVE)
        self.Frame13.configure(borderwidth="2")
        self.Frame13.configure(relief=GROOVE)
        self.Frame13.configure(width=435)

        self.Button6 = Button(self.TNotebook1_t3)
        self.Button6.place(relx=0.208, rely=0.148, height=47, width=97)
        ...
        self.Label16.place(relx=0.336, rely=0.163, height=29, width=76)
        ...
        self.Button7.place(relx=0.603, rely=0.148, height=47, width=87)
