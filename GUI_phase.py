...
#    Oct 03, 2018 11:47:28 AM CEST  platform: Linux
...
class PHASE_TRACKING_GUI:
    def __init__(self, top=None):
        ...
        self.Label3.place(relx=0.492, rely=0.609, height=21, width=76)
        self.Label3.configure(activebackground="#f9f9f9")
        self.Label3.configure(text='''Delimiter:''')

        self.Entry1 = Entry(self.Frame2)
        self.Entry1.place(relx=0.581, rely=0.609,height=21, relwidth=0.04)
        ...
        self.Button3.place(relx=0.888, rely=0.261, height=34, width=69)
        ...
        self.Label8.place(relx=0.648, rely=0.609, height=19, width=50)
        self.Label8.configure(text='''Chunck:''')

        self.Entry8 = Entry(self.Frame2)
        self.Entry8.place(relx=0.715, rely=0.609,height=21, relwidth=0.085)
        self.Entry8.configure(background="white")
        self.Entry8.configure(font="TkFixedFont")
        self.Entry8.configure(width=76)
