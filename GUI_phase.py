...
#    Oct 04, 2018 03:55:31 PM CEST  platform: Linux
...
class PHASE_TRACKING_GUI:
    def __init__(self, top=None):
        ...
        self.Frame2.place(relx=0.019, rely=0.015, relheight=0.17, relwidth=0.928)
        ...
        self.Label11.place(relx=0.831, rely=0.565, height=19, width=36)
        self.Label11.configure(textvariable=GUI_phase_support.upload_check)

        self.Frame3 = Frame(self.TNotebook1_t0)
        self.Frame3.place(relx=0.019, rely=0.192, relheight=0.687
                , relwidth=0.928)
        ...
        self.Frame4.place(relx=0.076, rely=0.177, relheight=0.399
                , relwidth=0.409)
        ...
        self.Frame5.place(relx=0.485, rely=0.177, relheight=0.399
                , relwidth=0.409)
        ...
        self.Frame6.place(relx=0.076, rely=0.576, relheight=0.399
                , relwidth=0.409)
        ...
        self.Frame7.place(relx=0.485, rely=0.576, relheight=0.399
                , relwidth=0.409)
        ...
        self.Button4.place(relx=0.086, rely=0.074, height=27, width=82)
        ...
        self.Labelframe1.place(relx=0.19, rely=0.015, relheight=0.155
                , relwidth=0.295)
        ...
        self.Entry9.place(relx=0.355, rely=0.286, height=21, relwidth=0.31
                , bordermode='ignore')
        ...
        self.Entry9.configure(width=96)

        self.Entry10 = Entry(self.Labelframe1)
        self.Entry10.place(relx=0.355, rely=0.571, height=21, relwidth=0.31
                , bordermode='ignore')
        ...
        self.Entry10.configure(width=96)

        self.Label9 = Label(self.Labelframe1)
        self.Label9.place(relx=0.032, rely=0.286, height=19, width=57
                , bordermode='ignore')
        self.Label9.configure(text='''Cut freq.:''')

        self.Label10 = Label(self.Labelframe1)
        self.Label10.place(relx=0.032, rely=0.571, height=19, width=93
                , bordermode='ignore')
        self.Label10.configure(text='''Sampling freq.:''')

        self.Checkbutton1 = Checkbutton(self.Labelframe1)
        self.Checkbutton1.place(relx=0.726, rely=0.429, relheight=0.2
