...
#    Oct 05, 2018 03:07:19 PM CEST  platform: Linux
...
class PHASE_TRACKING_GUI:
    def __init__(self, top=None):
        ...
        self.Button1.place(relx=0.062, rely=0.609, height=27, width=68)
        self.Button1.configure(activebackground="#d9d9d9")
        self.Button1.configure(text='''Search''')
        self.Button1.bind('<Button-1>',lambda e:GUI_phase_support.Search_pressed(e))

        self.Text1 = Text(self.Frame2)
        self.Text1.place(relx=0.164, rely=0.609, relheight=0.226, relwidth=0.263)
        ...
        self.Label3.place(relx=0.451, rely=0.609, height=21, width=76)
        self.Label3.configure(activebackground="#f9f9f9")
        self.Label3.configure(text='''Delimiter:''')

        self.Entry1 = Entry(self.Frame2)
        self.Entry1.place(relx=0.533, rely=0.609,height=21, relwidth=0.037)
        ...
        self.Button3.place(relx=0.815, rely=0.261, height=34, width=69)
        ...
        self.Label8.place(relx=0.595, rely=0.609, height=19, width=50)
        self.Label8.configure(activebackground="#f9f9f9")
        self.Label8.configure(text='''Chunck:''')

        self.Entry8 = Entry(self.Frame2)
        self.Entry8.place(relx=0.656, rely=0.609,height=21, relwidth=0.078)
        ...
        self.Label11.place(relx=0.831, rely=0.609, height=19, width=36)
        ...
        self.Label4.place(relx=0.021, rely=0.215, height=19, width=21)
        self.Label4.configure(activebackground="#f9f9f9")
        self.Label4.configure(text='''DE''')

        self.Label5 = Label(self.Frame3)
        self.Label5.place(relx=0.021, rely=0.366, height=19, width=19)
        self.Label5.configure(activebackground="#f9f9f9")
        self.Label5.configure(text='''TE''')

        self.Label6 = Label(self.Frame3)
        self.Label6.place(relx=0.021, rely=0.516, height=19, width=20)
        ...
        self.Label7.place(relx=0.021, rely=0.667, height=19, width=112)
        self.Label7.configure(activebackground="#f9f9f9")
        self.Label7.configure(text='''number of points:''')

        self.Entry6 = Entry(self.Frame3)
        self.Entry6.place(relx=0.308, rely=0.366,height=21, relwidth=0.068)
        self.Entry6.configure(background="white")
        self.Entry6.configure(font="TkFixedFont")
        self.Entry6.configure(textvariable=GUI_phase_support.st_te)
        ...
        self.Entry7.configure(textvariable=GUI_phase_support.st_ph)
        self.Entry7.configure(selectbackground="#c4c4c4")

        self.point_num_entry = Entry(self.Frame3)
        self.point_num_entry.place(relx=0.164, rely=0.656,height=21, relwidth=0.068)
        ...
        self.Label12.place(relx=0.611, rely=0.462, height=19, width=19
                , bordermode='ignore')
